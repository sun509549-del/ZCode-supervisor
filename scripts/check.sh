...
python3 -m unittest tests/test_zcode_supervisor.py tests/test_zcode_repo_setup.py tests/test_zcode_eval.py tests/test_codex_usage.py tests/test_goal_o_accounting.py tests/test_goal_p_codex_worker_comparison.py tests/test_zcode_release.py tests/test_homebrew_formula.py tests/test_distribution_packaging.py tests/test_pypi_readiness.py tests/test_public_release_surface.py tests/test_strict_contract_comparison.py tests/test_strict_path_reference_normalization.py tests/test_rollout_readiness.py tests/test_live_retry_preflight.py tests/test_zcode_one_task_loop.py tests/test_zcode_20_resumable_runner.py tests/test_zcode_20_resumable_state.py tests/test_zcode_20_provider_cooldown.py tests/test_zcode_20_usage_capture.py
